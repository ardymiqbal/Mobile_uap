...
import 'package:tes1/app/modules/register/views/register_page.dart'; // Import RegisterPage
...
import 'package:tes1/app/modules/register/bindings/register_binding.dart';
...
class AppPages {
  static final routes = [
    ...
    GetPage(
      name: '/register', // New route for RegisterPage
      page: () => RegisterPage(),
      binding: RegisterBinding(), // Ensure you have a RegisterBinding defined
    ),
    GetPage(
      name: '/home',
      page: () => HomePage(),
